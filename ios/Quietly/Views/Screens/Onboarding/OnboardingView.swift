...
struct OnboardingView: View {
    ...
    private let pages: [OnboardingPage] = [
        OnboardingPage(
            ...
            description: "Track your reading, capture quotes, and build lasting reading habits."
        ),
        OnboardingPage(
            icon: "clock.fill",
        ...
        OnboardingPage(
            ...
            subtitle: "Notes & Quotes",
            description: "Save your favorite quotes by scanning book pages or typing notes as you read."
        ),
        OnboardingPage(
            icon: "flame.fill",
...
struct OnboardingPageView: View {
    ...
    var body: some View {
        VStack(spacing: 24) {
            ...
            ZStack {
                Circle()
                    .fill(Color.quietly.primary.opacity(0.1))
                    .frame(width: 160, height: 160)

                Circle()
                    .fill(Color.quietly.primary.opacity(0.2))
